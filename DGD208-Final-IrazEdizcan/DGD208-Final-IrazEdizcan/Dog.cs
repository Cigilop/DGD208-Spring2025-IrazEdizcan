...
public class Dog : IPet
{
    ...
    {
        Console.Clear();
        Console.WriteLine($"You adopted a dog named {Name}! Loyal and happy.");
        Console.WriteLine("Press Enter to begin caring for your dog.");
        Console.ReadLine();
        ...
        while (isAlive)
        {
            ...
            Console.WriteLine("1. Feed (uses Food)");
            ...
            {
                case "1":
                    UseItem(inventory, "Dog Food", () => Hunger = Math.Min(Hunger + 30, 100));
                    break;
                case "2":
        ...
        Console.WriteLine("Your dog has been removed from the game. Press Enter.");
        Console.ReadLine();
    }
