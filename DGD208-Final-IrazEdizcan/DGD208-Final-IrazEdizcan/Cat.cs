...
public class Cat : IPet
{
    ...
    {
        Console.Clear();
        Console.WriteLine($"You adopted a cat named {Name}! Grumpy but secretly loves you.");
        Console.WriteLine("Press Enter to begin caring for your cat.");
        Console.ReadLine();
        ...
        while (isAlive)
        {
            ...
            Console.WriteLine("1. Feed (uses Cat Food)");
            ...
            {
                case "1":
                    UseItem(inventory, "Cat Food", () => Hunger = Math.Min(Hunger + 30, 100));
                    break;
                case "2":
        ...
        Console.WriteLine("Your cat has been removed from the game. Press Enter.");
        Console.ReadLine();
    }
